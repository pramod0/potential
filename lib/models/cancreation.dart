class Autogenerated {
  CANIndFillEezzReq? cANIndFillEezzReq;

  Autogenerated({this.cANIndFillEezzReq});

  Autogenerated.fromJson(Map<String, dynamic> json) {
    cANIndFillEezzReq = json['CANIndFillEezzReq'] != null
        ? CANIndFillEezzReq.fromJson(json['CANIndFillEezzReq'])
        : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    if (cANIndFillEezzReq != null) {
      data['CANIndFillEezzReq'] = cANIndFillEezzReq!.toJson();
    }
    return data;
  }
}
